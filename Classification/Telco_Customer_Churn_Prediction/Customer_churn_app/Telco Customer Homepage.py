...
# Create 3 columns for controlling layout of page
left_col, cent_col, last_col = st.columns(spec=[0.1, 0.8, 0.1])
with cent_col:
    st.image(os.path.join(os.path.dirname(__file__), 'static', 'Telco_logo.png'))
    st.title('Telco Customer Churn 🗣️')

# Sidebar for selecting app functions
